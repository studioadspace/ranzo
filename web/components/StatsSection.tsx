...
export default function StatsSection() {
  ...
  return (
    <section ref={ref} style={{ background: "#0e0e0c", padding: `70px ${PAD} 60px` }}>
      <div style={{ maxWidth: MAX_W, margin: "0 auto" }}>
        <motion.p
          style={{ fontSize: "13px", fontWeight: 600, color: "rgba(240,236,228,0.75)", letterSpacing: "0.18em", textTransform: "uppercase", fontFamily: "var(--font-instrument), serif", marginBottom: "20px" }}
        ...
        <motion.p
          style={{ fontSize: "clamp(17px, 1.1vw, 19px)", fontWeight: 300, color: "#fff", lineHeight: 1.85, maxWidth: "540px", marginBottom: "60px" }}
        ...
        <div style={{ position: "relative" }}>
          ...
          >
            ...
            <p style={{ fontSize: "15px", color: "#fff", fontWeight: 400, marginTop: "8px", letterSpacing: "0.02em" }}>
        ...
        <motion.div
          style={{ height: "1px", background: "rgba(255,255,255,0.05)", marginTop: "60px" }}
